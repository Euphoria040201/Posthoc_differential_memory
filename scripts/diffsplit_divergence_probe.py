...
def main() -> None:
    ...
    def sweep(label: str, *, zero=False, shuffle=False) -> dict:
        ...
        set_read_control(model, zero=False, shuffle=False)
        rows = {}
    ...
    res["trained_shuffled_window"] = sweep("TRAINED + shuffled local window",
                                           shuffle=True)
