...
from deltamem.core.backbone_compat import ensure_attention_compat_views
from deltamem.core.delta_impl import (
    SUPPORTED_BASE_ATTENTION_TYPES,
    VALID_DELTA_HEADS,
...
class DeltaMemAttention(ExperimentalDeltaMemAttention):
    def __init__(self, base: nn.Module, config: HFDeltaMemConfig) -> None:
